...
class Reinforce():
    ...
    def create_variables(self):
        ...
        self.log("Create scope for computing gradients.")
        ...
        with tf.name_scope("compute_gradients"):
            ...
            self.cross_entropy_loss = tf.nn.softmax_cross_entropy_with_logits_v2(logits=self.logprobs[:, -1, :], labels=self.states)
